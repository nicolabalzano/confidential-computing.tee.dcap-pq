...
our %config = (
    ...
    "CFLAGS" => [
        "-Wall -O3",
        "-include/home/alocin-local/tdx-pq-attestation/confidential-computing.tee.dcap-pq/QuoteVerification/sgxssl/Linux/../openssl_source/bypass_to_sgxssl.h"
    ],
    "CPPDEFINES" => [
        "_FORTIFY_SOURCE=2",
    ...
    "openssl_sys_defines" => [],
    "openssldir" => "",
    "options" => "--config=sgx_config.conf --with-rand-seed=none -D_FORTIFY_SOURCE=2 -DGETPID_IS_MEANINGLESS -DOPENSSL_NO_POSIX_IO -include/home/alocin-local/tdx-pq-attestation/confidential-computing.tee.dcap-pq/QuoteVerification/sgxssl/Linux/../openssl_source/bypass_to_sgxssl.h no-acvp-tests no-afalgeng no-apps no-asan no-async no-bf no-buildtest-c++ no-camellia no-capieng no-cast no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-dso no-dynamic-engine no-ec2m no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fips no-fips-securitychecks no-fuzz-afl no-fuzz-libfuzzer no-idea no-ktls no-loadereng no-md2 no-md4 no-mdc2 no-module no-msan no-padlockeng no-rc4 no-rc5 no-sctp no-shared no-srp no-ssl3 no-ssl3-method no-stdio no-tests no-trace no-ubsan no-ui-console no-unit-test no-uplink no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
    "patch" => "19",
    "perl_archname" => "x86_64-linux-gnu-thread-multi",
    "perl_cmd" => "/usr/bin/perl",
    "perl_version" => "5.38.2",
    "perlargv" => [
        "--config=sgx_config.conf",
        "sgx-linux-x86_64",
        "--with-rand-seed=none",
        "no-idea",
        "no-mdc2",
...
unless (caller) {
    ...
    use lib '/home/alocin-local/tdx-pq-attestation/confidential-computing.tee.dcap-pq/QuoteVerification/sgxssl/openssl_source/openssl-3.0.19/util/perl';
    use OpenSSL::fallback '/home/alocin-local/tdx-pq-attestation/confidential-computing.tee.dcap-pq/QuoteVerification/sgxssl/openssl_source/openssl-3.0.19/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib '/home/alocin-local/tdx-pq-attestation/confidential-computing.tee.dcap-pq/QuoteVerification/sgxssl/openssl_source/openssl-3.0.19/Configurations';
        use gentemplate;
